                ...
                <div className="flex flex-col-reverse w-[100%] h-[fit-content] pt-5">
                    ...
                    <div key="id" className="mb-[40px]">
                        <div className="flex flex-row w-[100%] p-1">
                            ...
                            <button className="bg-purple-100 px-3 ml-11 w-[10%] border border-purple-800 shadow-xl rounded-md hover:bg-purple-300" onClick={() => chooseCandidate(index+1)}>Vote</button>
                        </div>
                    </div>
                    )
                )}
