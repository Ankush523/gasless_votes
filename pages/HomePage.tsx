...
const HomePage = () => {
    return (
        ...
        <div className='flex flex-row w-[100vw] h-[fit-content] p-[20px] justify-around'>
            ...
            <Link href='/candidate'><button className='text-[20px] w-[fit-content] h-[fit-content] rounded-md hover:shadow-xl p-[8px] bg-purple-800 text-white'>Register as Candidate</button></Link>
